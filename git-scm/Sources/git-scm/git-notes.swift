...
static let quiet: Self = "--quiet"
    ...
    static func reeditMessage(object: String) -> Self { .init("--reedit-message=\(object)") }
    ///  --ref <ref>
    static func ref(ref: String) -> Self { .init("--ref \(ref)") }
    ///  --reuse-message=<object>
    static func reuseMessage(object: String) -> Self { .init("--reuse-message=\(object)") }
    ///  --stdin
