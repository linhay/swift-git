...
static let editTodo: Self = "--edit-todo"
    ...
    ///  --exec <cmd>
    static func exec(cmd: String) -> Self { .init("--exec \(cmd)") }
    ///  --force-rebase
...
static let noVerify: Self = "--no-verify"
    ///  --onto <newbase>
    static func onto(newbase: String) -> Self { .init("--onto \(newbase)") }
    ///  --quiet
...
static let stat: Self = "--stat"
    ...
    static func strategyOption(strategyOption: String) -> Self { .init("--strategy-option=\(strategyOption)") }
    ///  --strategy=<strategy>
...
static let verify: Self = "--verify"
    ///  --whitespace=<option>
    static func whitespace(option: String) -> Self { .init("--whitespace=\(option)") }
