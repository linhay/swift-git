...
static let binary: Self = "--binary"
    ...
    static func buildFakeAncestor(file: String) -> Self { .init("--build-fake-ancestor=\(file)") }
    ///  --cached
static let cached: Self = "--cached"
    ///  --check
static let check: Self = "--check"
    ///  --directory=<root>
    static func directory(root: String) -> Self { .init("--directory=\(root)") }
    ///  --exclude=<path-pattern>
    static func exclude(pathPattern: String) -> Self { .init("--exclude=\(pathPattern)") }
    ///  --ignore-space-change
...
static let inaccurateEof: Self = "--inaccurate-eof"
    ...
    static func include(pathPattern: String) -> Self { .init("--include=\(pathPattern)") }
    ///  --index
...
static let verbose: Self = "--verbose"
    ///  --whitespace=<action>
    static func whitespace(action: String) -> Self { .init("--whitespace=\(action)") }
