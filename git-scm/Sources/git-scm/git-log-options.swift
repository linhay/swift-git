...
static let abbrevCommit: Self = "--abbrev-commit"
    ...
    ///  --after=<date>
    static func after(date: String) -> Self { .init("--after=\(date)") }
    ///  --all
...
static let authorDateOrder: Self = "--author-date-order"
    ///  --author=<pattern>
    static func author(pattern: String) -> Self { .init("--author=\(pattern)") }
    ///  --basic-regexp
static let basicRegexp: Self = "--basic-regexp"
    ///  --before=<date>
    static func before(date: String) -> Self { .init("--before=\(date)") }
    ///  --binary
...
static let boundary: Self = "--boundary"
    ///  --branches[=<pattern>]
    static func branches(pattern: [String]) -> Self { .init("--branches=\(pattern.joined(separator: ","))") }
    ///  --break-rewrites[=[<n>][/<m>]]
...
static let combinedAllPaths: Self = "--combined-all-paths"
    ///  --committer=<pattern>
    static func committer(pattern: String) -> Self { .init("--committer=\(pattern)") }
    ///  --compact-summary
...
static let dateOrder: Self = "--date-order"
    ///  --date=<format>
    static func date(format: String) -> Self { .init("--date=\(format)") }
    ///  --decorate-refs-exclude=<pattern>
    static func decorateRefsExclude(pattern: String) -> Self { .init("--decorate-refs-exclude=\(pattern)") }
    ///  --decorate-refs=<pattern>
    static func decorateRefs(pattern: String) -> Self { .init("--decorate-refs=\(pattern)") }
...
static let excludeFirstParentOnly: Self = "--exclude-first-parent-only"
    ...
    static func exclude(globPattern: String) -> Self { .init("--exclude=\(globPattern)") }
    ///  --expand-tabs
...
static let functionContext: Self = "--function-context"
    ///  --glob=<glob-pattern>
    static func glob(globPattern: String) -> Self { .init("--glob=\(globPattern)") }
    ///  --graph
static let graph: Self = "--graph"
    ///  --grep-reflog=<pattern>
    static func grepReflog(pattern: String) -> Self { .init("--grep-reflog=\(pattern)") }
    ///  --grep=<pattern>
    static func grep(pattern: String) -> Self { .init("--grep=\(pattern)") }
    ///  --histogram
...
static let mailmap: Self = "--mailmap"
    ///  --max-count=<number>
    static func maxCount(number: String) -> Self { .init("--max-count=\(number)") }
    ///  --max-parents=<number>
    static func maxParents(number: String) -> Self { .init("--max-parents=\(number)") }
    ///  --merge
static let merge: Self = "--merge"
    ///  --merges
static let merges: Self = "--merges"
    ///  --min-parents=<number>
    static func minParents(number: String) -> Self { .init("--min-parents=\(number)") }
    ///  --minimal
...
static let remergeDiff: Self = "--remerge-diff"
    ///  --remotes[=<pattern>]
    static func remotes(pattern: [String]) -> Self { .init("--remotes=\(pattern.joined(separator: ","))") }
    ///  --remove-empty
...
static let shortstat: Self = "--shortstat"
    ...
    static func showLinearBreak(barrier: [String]) -> Self { .init("--show-linear-break=\(barrier.joined(separator: ","))") }
    ///  --show-notes[=<ref>]
...
static let simplifyMerges: Self = "--simplify-merges"
    ///  --since=<date>
    static func since(date: String) -> Self { .init("--since=\(date)") }
    ///  --single-worktree
static let singleWorktree: Self = "--single-worktree"
    ///  --skip-to=<file>
    static func skipTo(file: String) -> Self { .init("--skip-to=\(file)") }
    ///  --skip=<number>
    static func skip(number: String) -> Self { .init("--skip=\(number)") }
    ///  --source
...
static let summary: Self = "--summary"
    ///  --tags[=<pattern>]
    static func tags(pattern: [String]) -> Self { .init("--tags=\(pattern.joined(separator: ","))") }
    ///  --text
...
static let topoOrder: Self = "--topo-order"
    ...
    ///  --until=<date>
    static func until(date: String) -> Self { .init("--until=\(date)") }
    ///  --use-mailmap
