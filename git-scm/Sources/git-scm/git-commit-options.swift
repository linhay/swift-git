...
static let amend: Self = "--amend"
    ///  --author=<author>
    static func author(author: String) -> Self { .init("--author=\(author)") }
    ///  --branch
static let branch: Self = "--branch"
    ///  --cleanup=<mode>
    static func cleanup(mode: String) -> Self { .init("--cleanup=\(mode)") }
    ///  --date=<date>
    static func date(date: String) -> Self { .init("--date=\(date)") }
    ///  --dry-run
...
static let long: Self = "--long"
    ///  --message=<msg>
    static func message(msg: String) -> Self { .init("--message=\(msg)") }
    ///  --no-edit
...
static let quiet: Self = "--quiet"
    ...
    static func reeditMessage(commit: String) -> Self { .init("--reedit-message=\(commit)") }
    ///  --reset-author
static let resetAuthor: Self = "--reset-author"
    ///  --reuse-message=<commit>
    static func reuseMessage(commit: String) -> Self { .init("--reuse-message=\(commit)") }
    ///  --short
static let short: Self = "--short"
    ///  --signoff
static let signoff: Self = "--signoff"
    ///  --squash=<commit>
    static func squash(commit: String) -> Self { .init("--squash=\(commit)") }
    ///  --status
static let status: Self = "--status"
    ///  --template=<file>
    static func template(file: String) -> Self { .init("--template=\(file)") }
    ///  --untracked-files[=<mode>]
    static func untrackedFiles(mode: [String]) -> Self { .init("--untracked-files=\(mode.joined(separator: ","))") }
    ///  --verbose
