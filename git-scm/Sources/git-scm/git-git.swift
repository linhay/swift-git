...
static let bare: Self = "--bare"
    ///  --exec-path[=<path>]
    static func execPath(path: [String]) -> Self { .init("--exec-path=\(path.joined(separator: ","))") }
    ///  --git-dir=<path>
    static func gitDir(path: String) -> Self { .init("--git-dir=\(path)") }
    ///  --glob-pathspecs
...
static let manPath: Self = "--man-path"
    ///  --namespace=<path>
    static func namespace(path: String) -> Self { .init("--namespace=\(path)") }
    ///  --no-optional-locks
...
static let paginate: Self = "--paginate"
    ///  --super-prefix=<path>
    static func superPrefix(path: String) -> Self { .init("--super-prefix=\(path)") }
    ///  --version
static let version: Self = "--version"
    ///  --work-tree=<path>
    static func workTree(path: String) -> Self { .init("--work-tree=\(path)") }
