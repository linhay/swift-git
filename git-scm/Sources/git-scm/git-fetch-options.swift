...
static let autoMaintenance: Self = "--auto-maintenance"
    ///  --deepen=<depth>
    static func deepen(depth: String) -> Self { .init("--deepen=\(depth)") }
    ///  --depth=<depth>
...
static let refetch: Self = "--refetch"
    ///  --refmap=<refspec>
    static func refmap(refspec: String) -> Self { .init("--refmap=\(refspec)") }
...
static let stdin: Self = "--stdin"
    ...
    static func submodulePrefix(path: String) -> Self { .init("--submodule-prefix=\(path)") }
    ///  --tags
